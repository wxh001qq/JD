...
def get_action_user_feat0515_2_3(start_date, end_date, n):
    dump_path = './cache/get_action_user_feat0515_2_3_%s_%s_%s.csv' % (start_date, end_date, n)
    if os.path.exists(dump_path):
        actions = pd.read_csv(dump_path)
    else:
        ...
        actions_gouwuche_2= actions_gouwuche[actions['cate']==8][['user_id','type']]
        ...
        actions_guanzhu_2= actions_guanzhu[actions['cate']==8][['user_id','type']]
